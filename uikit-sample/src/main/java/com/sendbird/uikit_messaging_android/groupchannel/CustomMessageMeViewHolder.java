...
import com.sendbird.uikit_messaging_android.databinding.ViewCustomMessageMeHolderBinding;

public class CustomMessageMeViewHolder extends MessageViewHolder {
    private final ViewCustomMessageMeHolderBinding binding;

    public CustomMessageMeViewHolder(ViewCustomMessageMeHolderBinding binding) {
